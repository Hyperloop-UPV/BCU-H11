...
class Comms{
    public:
    template<typename DataMotor,typename DataCurrentSenseA,typename DataCurrentSenseB,typename DataSpeetec>
    static void init(DataMotor& dataMotor, DataCurrentSenseA& dataCurrentSenseA,DataCurrentSenseB& dataCurrentSenseB,DataSpeetec& dataSpeetec){
        DataPackets::Motor_Info_Init(dataMotor.duty_cycle_u,dataMotor.duty_cycle_v,dataMotor.duty_cycle_w,dataMotor.frequency,
                data.dead_time_ns,reinterpret_cast<DataPackets::Motor_State&>(dataMotor.state));
    ...
    inline static uint32_t dead_time_ns_received{};
