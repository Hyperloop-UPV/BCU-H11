...
namespace Devices{
template<typename Board,typename EncoderTimer,std::size_t Samples,typename EncoderSupply = Devices::NoSupply>
class Encoder{
public:
struct Data{
        double position;
    ...
    Encoder(double counter_distance_m, double sample_time_s):
