...
#ifdef DEBUG
inline constexpr int32_t CurrentControlPeriod = 1000;
#else
...
// Leds
inline constexpr auto& kLED_Operational = ST_LIB::PG8;
inline constexpr auto& kLED_Fault = ST_LIB::PG7;
inline constexpr auto& kLED_Connecting = ST_LIB::PG4;
inline constexpr auto& kLED_SpaceVector = ST_LIB::PG6;
inline constexpr auto& kLED_CurrentControl = ST_LIB::PD10;
inline constexpr auto& kLED_SpeedControl = ST_LIB::PD9;
// speetec 1
inline constexpr auto& kSpeedtec1_IN1 = ST_LIB::PF0;
inline constexpr auto& kSpeedtec1_IN2 = ST_LIB::PF1;
...
// temp sensors
inline constexpr auto& kTempSensorA = ST_LIB::PF7;
inline constexpr auto& kTempSensorB = ST_LIB::PF10;
