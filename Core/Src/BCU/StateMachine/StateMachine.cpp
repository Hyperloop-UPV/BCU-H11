...
namespace BCU {
//-----Transitions-------------------------//
bool StateMachine::trans_to_operational() { return Comms::is_connected(); }
bool StateMachine::trans_to_fault() {
    return !Comms::is_connected(); // || other things
}
bool StateMachine::trans_to_idle() { return OrderPackets::Stop_Control_flag; }
bool StateMachine::trans_to_testPWM() { return OrderPackets::Start_Test_PWM_flag; }
bool StateMachine::trans_to_spaceVector() { return OrderPackets::Start_Space_Vector_flag; }
bool StateMachine::trans_to_currentControl() { return OrderPackets::Start_Current_Control_flag; }
bool StateMachine::trans_to_speedControl() { return OrderPackets::Start_Speed_Control_flag; }
//---Enter Actions --------------------------//
...
void StateMachine::on_space_vector() { Controller::on_space_vector(); }
void StateMachine::on_current_control() { Controller::on_current_control(); }
void StateMachine::on_speed_control() { Controller::on_speed_control(); }
} // namespace BCU
